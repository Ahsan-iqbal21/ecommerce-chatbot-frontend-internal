...
const Chat = () => {
  ...
  const { chats, chatHistory, selectedChatId, loading, handleSelectChat } =
    useGetChats();
                    ...
                    sx={{
                      ...
                      backgroundColor:
                        selectedChatId === chat.chatId
                          ...
                          : "transparent",
                      borderRadius:
                        selectedChatId === chat.chatId ? "9px" : "0",
                    }}
                  >
                    <Tooltip
                      title={chat.title}
              ...
              >
                ...
                >
                  <Typography variant="h5">
                    Write something to chat with our AI Chatbot!
                  </Typography>
                </Box>
              </Box>
            )}
